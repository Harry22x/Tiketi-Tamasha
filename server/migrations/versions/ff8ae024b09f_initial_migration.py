...
Revision ID: ff8ae024b09f
Revises: 
Create Date: 2025-02-18 11:52:22.882193
...
def upgrade():
    ...
    sa.Column('ticket_type', sa.Enum('REGULAR', 'VIP', 'ADVANCED', name='tickettype'), nullable=False),
